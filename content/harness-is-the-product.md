...
created: 2026-04-02
date: 2026-04-03
tags: [AI, agent-harness, DSPy, TextGrad, ADAS, meta-harness, quality-gates]
topics:
  - AI
qc: passed
spec: "The harness — code between LM calls — is where capability and safety live. 11 papers from 2023-2026 prove this across 3 phases: compile-time optimization (DSPy), runtime optimization (TextGrad/Trace), automated discovery (ADAS/AgentBreeder) | creator — synthesized 11 papers + personal hook system experience | practitioners building AI agent systems"
---
...
If you want to start adding quality gates to your own agent workflow, I built [agent-gates](https://github.com/zl190/agent-gates) — structural enforcement you can drop in with zero dependencies.
