---
title: "22/22 Tests Pass. The System Was 100% Broken."
created: 2026-04-01
date: 2026-04-03
tags: [AI, testing, quality-gates, agent-harness, debugging]
topics:
  - AI
qc: passed
spec: "22 green tests, zero working enforcement. Root cause: test validated the audit step, never checked the gate step. Three failure patterns for agent-produced test suites: cross-file naming, happy-path-only, replicated bad patterns | creator — personal debugging experience with noGlaze hooks | developers testing AI agent systems"
---
